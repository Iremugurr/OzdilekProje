...
public class WomanPage extends BaseTest{
    @Step("<int> saniyeye kadar bekle")
    public void waitForSecond(int s)throws InterruptedException{
        Thread.sleep(1000 *s);
    }
    @Step("Xpath <xpath> ine sahip elementi bul ve tıkla")
    public void clickElement(String xpath){
        MobileElement element = appiumDriver.findElement(By.xpath(xpath));
        element.click();
    }
    @Step("Sayfa aşağı doğru iki kere scroll edilir")
    public void swipeUp(){
