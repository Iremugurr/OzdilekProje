...
public class BaseTest {
    ...
    if (localAndroid){
        System.out.println("Ozdilekteyim mobil testi baslıyor");
        ...
        desiredCapabilities.setCapability(NEW_COMMAND_TIMEOUT,4000);
        URL url = new URL("http://127.0.0.1:4723/wd/hub");
        appiumDriver = new AndroidDriver(url,desiredCapabilities);

    }else{
        System.out.println("Ozdilekteyim ios testi baslıyor");
        DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
        ...
        desiredCapabilities.setCapability(MobileCapabilityType.DEVICE_NAME,"İphone" );
